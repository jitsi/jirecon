...
public interface MediaService
{
    ...
    /**
     * Creates a <tt>MediaDevice</tt> which provides silence in the form of audio
     * media and does not play back any (audio) media.
     */
    public MediaDevice createAudioSilenceMediaDevice();
}
