...
public class RawPacket
{
    ...
    /**
     * Reads 32 bits (as an unsigned integer) from this packet at the specified
     * offset.
     * @param off the offset at which to read.
     * @return the java <tt>long</tt> representation of the 32 bits (read as an
     * unsigned integer) starting at offset <tt>off</tt> in this packet.
     */
    public long read32BitsAsLong(int off)
    {
        return 0xffffffffL & readInt(off);
    }
